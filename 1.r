# 1
# Турчак Карина – для региона 19 рассчитайте урожайность пшеницы в 2016 году, 
# взяв для рассчета средние суммы активных температур за предыдущие 4 года, с 15 ближайших метеостанций
#53.710509, 91.454428
...
#создадим таблицу
all_data = tibble()
#запишем в таблицу данные для станций
